...
public class DbConnector {
	...
	public void check(String user, String email, String age, String pass) {
		try{  
			start();
			stmt.executeQuery("INSERT INTO USER (username,emailid,age,password) +"
					+ "VALUES('"+user+"','"+email+"','"+Integer.parseInt(age)+"','"+pass+"')");
